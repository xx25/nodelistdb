...
func (s *Server) SetupRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("/pointlists", s.PointlistIndexHandler)
	mux.HandleFunc("/pointlists/", s.PointlistIndexHandler)
	...
	mux.HandleFunc("/points/", s.PointHistoryHandler)
	mux.HandleFunc("/browse", s.BrowseZonesHandler)
	mux.HandleFunc("/browse/zone/", s.BrowseZoneHandler)
	mux.HandleFunc("/browse/region/", s.BrowseRegionHandler)
	mux.HandleFunc("/browse/net/", s.BrowseNetHandler)
	...
	mux.HandleFunc("/analytics/pstn-accessible", s.ModemAccessibleAnalyticsHandler)
	mux.HandleFunc("/analytics/pstn-no-answer", s.ModemNoAnswerAnalyticsHandler)
